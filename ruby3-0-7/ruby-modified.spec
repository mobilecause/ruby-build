...
Patch78:              9999-temp-disable-TMPFILE-tests.patch
Patch79:              9999-temp-disable-socket-tests.patch
...
%changelog
* Tue May 06 2025 Neil Hanlon <neil@rockylinux.org> - 3.0.7-165
- Temporarily disable O_TMPFILE tests which break in peridot build env
- Temporarily disable socket permission tests erroring in build env
